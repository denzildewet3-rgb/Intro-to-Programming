...
function openTheStand() {
  ...
  for (var i = 0; i < days.length; i++) {
    glassesSold = Math.floor(dailyTemp[i] / glassPrice); // glasses sold depends on temp and price
    glassesLeft = numGlasses - totalGlasses; // how many glasses do we have now?
...
// calculates results and displays report
